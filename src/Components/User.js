...
class User extends Component {
  render() {
    return (
        <div style={{ display : 'inline-block'}} class="col-lg-3 col-md-6 col-sm-12">
        <div class="container">
        <div class="row">
            <div class="">
                <div class="card hovercard" >
                    ...
                    <div class="info">
                        <div class="title" style={{ fontWeight : 700 }}>
                           {this.props.name}
                        </div>
                    ...
                    <div>
                        <p>This is what i wanted to develop This is what i wanted to develop This is what i wanted to develop</p>
                    </div>
                    <center>
                    <Link to={{ pathname:'/post/'+this.props.id}}>
    
     <Button variant="primary" style={{ width : 150 , margin : 15 }}>following</Button>   
     </Link>  
                    </center>
                </div>
            </div>
